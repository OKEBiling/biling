...
function() {
    ...
    Array.prototype.slice.call(e).forEach(function(a) {
        ...
        function(e) {
            a.checkValidity() ? alert("Submitted!!!") : (e.preventDefault(), e.stopPropagation()),
...
function(e) {
    {
        ...
        r = FormValidation.formValidation(t, {
            ...
            init: e = >{
                ...
                function(e) {
                    ...
                    e.element.parentElement.parentElement.classList.contains("custom-option") && e.element.closest(".row").insertAdjacentElement("afterend", e.messageElement)
                })
            }
        });
        var a, n;
        ...
        {
            name: "tech",
            source: (n = ["ReactJS", "Angular", "VueJS", "Html", "Css", "Sass", "Pug", "Gulp", "Php", "Laravel", "Python", "Bootstrap", "Material Design", "NodeJS"],
            function(e, a) {
                var t = [],
                o = new RegExp(e, "i");
                $.each(n,
